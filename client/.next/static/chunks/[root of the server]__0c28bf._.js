(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__0c28bf._.js", {
...
const UserContextProvider = ({ children, value })=>{
    ...
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(value);
...
_s(UserContextProvider, "qYpNhzC6z580NBHD/v1SpYB2zo0=");
...
_s(Header, "5PNiZVTHop4CgAh+6CmaPpnNhqQ=", false, function() {
    return [
...
MyApp.getInitialProps = async (context)=>{
    const appProps = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$app$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].getInitialProps(context);
    console.log(context);
    // console.log("cookies");
    const cookies = context.ctx.req?.headers.cookie || '';
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$axios$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["default"].get('/user/verify', {
        headers: {
            Cookie: cookies
        }
    });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0c28bf._.js.map