(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__8a6cf6._.js", {
...
const login = ()=>{
    ...
    const onSubmit = async (data)=>{
        // console.log(data);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$axios$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["default"].post('/user/login', {
                email: data.email,
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utilities$2f$features$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["responseToast"])(error?.response);
        }
    };
...
_s(login, "lJhWjIPS+N0GlfgVYnMd/sg6Emk=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8a6cf6._.js.map