...
export const SlideProductCard = ({ product, latest }: PageProps) => {
    ...
    return (
        <>
            <div className='border flex flex-col justify-center items-center p-4 shadow-sm rounded-2xl group bg-orange-50 hover:bg-orange-100'>
                <Image
