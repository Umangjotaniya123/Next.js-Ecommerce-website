...
export const getwishlist = TryCatch(async (req, res, next) => {
    ...
    const productsPromise = wishlist.productId.map((productId) => Product.findById(productId).select('name price photos category discount stock specification description'));
